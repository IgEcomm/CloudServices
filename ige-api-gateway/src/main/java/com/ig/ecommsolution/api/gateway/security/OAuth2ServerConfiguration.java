 ...
 * 
 */
package com.ig.ecommsolution.api.gateway.security;
...
import com.ig.ecommsolution.api.gateway.service.CustomUserDetailsService;
...
public class OAuth2ServerConfiguration {
	...
	private static final String RESOURCE_ID = "igerestservice";
	...
	protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
		...
		public void configure(HttpSecurity http) throws Exception {
			http.authorizeRequests().antMatchers("/productApi/**").authenticated().antMatchers("/gateway/**")
					.authenticated();
		}
